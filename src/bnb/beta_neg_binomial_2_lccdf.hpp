#ifndef STAN_MATH_PRIM_PROB_BETA_NEG_BINOMIAL_2_LCCDF_HPP
#define STAN_MATH_PRIM_PROB_BETA_NEG_BINOMIAL_2_LCCDF_HPP
...
inline stan::return_type_t<T_mu, T_sigma, T_gamma> beta_neg_binomial_2_lccdf(const T_n& n, 
                                                    const T_mu& mu,
                                                    const T_sigma& sigma,
                                                    const T_gamma& gamma,
  ...
  static const char* function = "beta_neg_binomial_2_lccdf";
  ...
  for (size_t i = 0; i < max_size_seq_view; i++) {
    const T_partials_return n_dbl = n_vec[i];
    ...
    if (!is_constant_all<T_sigma>::value) {
      ...
      ops_partials.edge2_.partials_[i]
          += y2r * r2sigma + y2alpha * alpha2sigma + y2beta * beta2sigma;
    }
